...
async function createExercise(formData) {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].exercise.create({
            data: {
                name,
                category,
                description
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/exercises");
        return {
            success: true
        };
    } catch (error) {
...
async function logExercise(formData) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].exerciseLog.create({
        data: {
            userId: user.id,
            exerciseId,
            weight,
...
async function deleteUser(userId) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].exerciseLog.deleteMany({
        where: {
            userId
        }
    });
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].user.delete({
        where: {
            id: userId
        }
    });
...
async function deleteExercise(exerciseId) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].exercise.delete({
        where: {
            id: exerciseId
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d4805c2._.js.map